...
-- Obtener las columnas y filas de una tabla
Select * from products;
Select * from categories;
Select * from customers;
Select * from orders;

--Obtener las columnas category_id, catogory_name de las tablas de categorias
Select category_id,category_name from categories;
--Obtener las columnas de id, nombree de producto y precio de la tabla de productos
Select product_id,product_name,unit_price from products;
 --Obtener las columnas de id,producto,cantidad de la tabla de productos.
 Select product_id,order_id,quantity from order_details;
 ...
 --Obtener los productos que tenga el precion entre 35 y 75
 Select * from PRODUCTS
